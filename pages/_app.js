      ...
      <header>
        <div className="header-div">
          ...
          <a
            ...
            href="https://www.instagram.com/takshila_gujarathi_choksi/"
            target="_blank"
          >
        ...
        <div className="ytcontainer">
          <div
            ...
            data-channelid="UC0UARGiSBq_raXNcZc5BzBg"
            data-layout="full"
            data-count="default"
          ></div>
        </div>
        ...
        <nav className="my-4">
          <ul className="flex flex-row justify-center space-x-4 navbar ">
            ...
            <li className={router.pathname == "/contribute" ? "active" : ""}>
              <Link href="/contribute">
                <a className="text-xl font-extrabold">Contribute</a>
              </Link>
            </li>
          </ul>
        </nav>
